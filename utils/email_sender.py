...
def send_email_with_attachment(to_email, subject, file_path, filename, sender_display_email=None):
    """
    ...
    try:
        ...
        params = {
            ...
            "html": f"""
                ...
                <p><b>Отправитель:</b> {sender_display_email or 'Не указан'}</p>
